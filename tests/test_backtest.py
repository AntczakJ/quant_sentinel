...
class TestEvaluatePredictions:
    def test_perfect_predictions(self):
        from src.analysis.backtest import evaluate_predictions
...
class TestEquityMetrics:
    def test_positive_returns(self):
        from src.analysis.backtest import compute_equity_metrics
...
class TestMonteCarlo:
    def test_simulation_returns_valid(self):
        from src.analysis.backtest import monte_carlo_simulation
...
class TestTransactionCosts:
    def test_costs_reduce_returns(self):
        from src.analysis.backtest import apply_transaction_costs
