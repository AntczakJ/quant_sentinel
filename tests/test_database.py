...
def main():
    ...
    try:
        ...
        balance = db.get_balance(12345)
        assert balance == 5000
        print("[OK] update_balance")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] update_balance: {e}")
    tests_total += 1
    ...
    try:
        ...
        assert val == 42.5
        print("[OK] get/set_param")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] get/set_param: {e}")
    tests_total += 1
    ...
    try:
        ...
        print("[OK] get_performance_stats")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] get_performance_stats: {e}")
    tests_total += 1
