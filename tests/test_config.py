...
def main():
    ...
    try:
        ...
        print("[OK] USER_PREFS has required keys")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] USER_PREFS: {e}")
    tests_total += 1
    ...
    try:
        ...
        print("[OK] LAST_STATUS has required keys")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] LAST_STATUS: {e}")
    tests_total += 1

    # Test 3: Thread safety
    try:
        assert isinstance(LAST_STATUS_LOCK, threading.Lock)
        print("[OK] LAST_STATUS_LOCK is thread-safe")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] Thread safety: {e}")
    tests_total += 1
    ...
    try:
        ...
        print("[OK] API credentials loaded")
        tests_passed += 1
    except Exception as e:
        print(f"[FAIL] API credentials: {e}")
    tests_total += 1
