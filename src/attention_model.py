...
def train_attention_model(df, model_dir='models', seq_len=60):
    ...
    """
    from src.compute import compute_features, compute_target, FEATURE_COLS, get_tf_batch_size
...
def predict_attention(df, model_dir='models', seq_len=60):
    ...
    try:
        ...
        from src.compute import detect_gpu, convert_keras_to_onnx, get_onnx_session, onnx_predict
        gpu_info = detect_gpu()
